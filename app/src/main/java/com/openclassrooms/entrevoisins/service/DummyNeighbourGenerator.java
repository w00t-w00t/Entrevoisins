...
/**
 * Dummy generator of neighbours
 */
public abstract class DummyNeighbourGenerator {

    /**
     * Generate a list of neighbours statically for the moment
     */
    public static List<Neighbour> DUMMY_NEIGHBOURS = Arrays.asList(
            new Neighbour(1, "Caroline", "https://i.pravatar.cc/150?u=a042581f4e29026704d", "Saint-Pierre-du-Mont ; 5km",
                    "+33 6 86 57 90 14",  "Bonjour !Je souhaiterais faire de la marche nordique. Pas initiée, je recherche une ou plusieurs personnes susceptibles de m'accompagner !J'aime les jeux de cartes tels la belote et le tarot.. Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla..  Bla bla bla.. "),
    ...
    /**
     * Return the static list of neighbours
